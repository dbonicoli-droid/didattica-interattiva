...
Per calcolare energia con potenza diversa in più intervalli, somma i prodotti potenza media × durata. Questa idea di accumulo prepara all'integrale.
...
## Livello 5B / Fourier: più frequenze insieme {#livello-5}
...
## Livello 5C / Laplace e confronto con i componenti con memoria {#livello-6}
...
Con la trasformata unilaterale, definita da $0^-$ in avanti:
