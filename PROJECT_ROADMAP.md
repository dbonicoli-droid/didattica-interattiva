...
- [ ] Mappe concettuali con relazioni etichettate, versione stampabile e indice testuale accessibile; estendere la prima mappa dei componenti.
- [ ] Attività Prevedi → prova → spiega.
